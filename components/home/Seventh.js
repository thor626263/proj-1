...
function Seventh(){
    return(
        ...
        <div className="seventh-sec">
           ...
           <img style={{height:"35px", width:"35px",marginTop:"7px" ,marginLeft:"-23px", zIndex:"-1"}} src={fourthcircle} alt="fourthcircle"/>
           </div>
        </div>
        ...
        <div style={{ display:"flex",marginTop:"2%", marginLeft:"620px"}}>
